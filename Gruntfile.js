...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      desktopsign: {
        cmd: 'gpg -u 0755AF6E --output "webkitbuilds/<%= pkg.title %>-linux.zip.sig" --detach-sig "webkitbuilds/<%= pkg.title %>-linux.zip" ; gpg -u 0755AF6E --output "webkitbuilds/<%= pkg.title %>.exe.sig" --detach-sig "webkitbuilds/<%= pkg.title %>.exe"'
      },
      desktopverify: {
      ...
      osxsign: {
        cmd: 'gpg -u 0755AF6E --output "webkitbuilds/<%= pkg.title %>.dmg.sig" --detach-sig "webkitbuilds/<%= pkg.title %>.dmg"'
      },
    },
    watch: {
      options: {
